...
def test_instanceworker_instantiate_ttfont_and_gen_restricted_and_unrestricted_subspace_multiaxis_woff(
    tmpdir,
):
    # When there are
    outpath = str(tmpdir.join("test.ttf"))
...
def test_instanceworker_instantiate_ttfont_and_gen_restricted_and_unrestricted_subspace_multiaxis_woff2(
    tmpdir,
):
    # When there are
    outpath = str(tmpdir.join("test.ttf"))
